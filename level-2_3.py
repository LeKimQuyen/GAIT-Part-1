...
pygame.display.set_caption("GridWorld - Part 1 Q-learning, Level 2-3")
...
# Level 2 layout (agent, apples and rocks)
LEVEL2 = load_layout(2)
LEVEL2 = [row.ljust(WIDTH_TILES)[:WIDTH_TILES] for row in LEVEL2]
...
class GridWorld:
    def __init__(self, layout: List[str]):
        ...
        self.start = (0, 0)
        # Animation
        self.apple_imgs, self.fire_imgs, self.rock_img, self.key_img, self.chest_imgs = load_images()
...
def load_images():
    ...
    return [apple0, apple1], [fire_0, fire_1, fire_2], rock, key, [chest_closed, chest_opened]
