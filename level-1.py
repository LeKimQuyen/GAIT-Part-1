'''
Task 2: Implement Basic Q-Learning for Level 1
'''
...
pygame.display.set_caption("GridWorld - Part 1 Q-learning, Level 1")
...
# Level 1 layout (agent, apples and fires)
LEVEL1 = load_layout(1)
LEVEL1 = [row.ljust(WIDTH_TILES)[:WIDTH_TILES] for row in LEVEL1]
...
class GridWorld:
    def __init__(self, layout: List[str]):
        ...
        self.start = (0, 0)
        # Animation
        self.apple_imgs, self.fire_imgs = load_images()
        self.apple_state = 0
    ...
    # def cell_contains_fire(self, p): return p in self.fires
...
def draw_grid(env: GridWorld, episode, step, epsilon, total_reward):
    ...
    hud = [
        ...
        f"Return {total_reward:.2f}  Part 1 Q-learning Level 1",
...
def load_images():
    ...
    # fires
    fire_0 = pygame.transform.scale(pygame.image.load(path + 'fire-0.png').convert_alpha(), (TILE_SIZE, TILE_SIZE))
    fire_1 = pygame.transform.scale(pygame.image.load(path + 'fire-1.png').convert_alpha(), (TILE_SIZE, TILE_SIZE))
    fire_2 = pygame.transform.scale(pygame.image.load(path + 'fire-2.png').convert_alpha(), (TILE_SIZE, TILE_SIZE))
    
    return [apple0, apple1], [fire_0, fire_1, fire_2]
